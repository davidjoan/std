...
abstract class BaseDocumentForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'document_class_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('DocumentClass'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'document_class_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('DocumentClass'))),
      'code'              => new sfValidatorString(array('max_length' => 50)),
      'issue'             => new sfValidatorString(array('max_length' => 200)),
