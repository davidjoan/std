        ...
        setInterval(function() {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(qty > records)
                    {
                        create("default", { title:'Nuevos Expedientes', text:'Porfavor haga click <a href=\'#\' onclick=\'window.location.reload()\'><b style=\'color: #FFFFFF; font: bold 34px;\'>Aqui</b></a> para ver los cambios.'},{ expires:false });
                    }
