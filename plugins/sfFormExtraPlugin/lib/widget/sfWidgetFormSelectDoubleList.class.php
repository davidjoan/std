...
class sfWidgetFormSelectDoubleList extends sfWidgetForm
{
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('unassociate', '<img src="/sfFormExtraPlugin/images/next.png" alt="unassociate" border="0" />');
    $this->addOption('associate', '<img src="/sfFormExtraPlugin/images/previous.png" alt="associate" border="0" />');
